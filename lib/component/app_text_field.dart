  ...
  Widget build(BuildContext context) {
    ...
    return TextSelectionTheme(
      data: TextSelectionThemeData(
        selectionColor: widget.accentColor?.withAlpha(33) ??
            currentTheme.primaryColor.withAlpha(33),
      ),
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(color: widget.textColor.withAlpha(45)),
              labelText:
